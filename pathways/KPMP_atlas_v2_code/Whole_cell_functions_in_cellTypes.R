...
################# User-input needed ##############################
overall_directory = "D:/KPMP_v2_atlas/KPMP_v2_data/" #ensure directories end with '/'
working_directory = "D:/KPMP_v2_atlas/KPMP_atlas_v2_code/" #has to contain the script 'KPMP_atlas_v2_shared_code.R'
