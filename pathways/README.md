...
5) The script 'Whole_cell_functions_in_cellTypes.R' generates heatmaps from the results generated by the 'Generate_pathwaySubtype_networks' script.

## Requirements
- As instructed in 'KPMP_atlas_v2_calculate_degs_and_pathways.R', the KPMP atlas v2 Single Nucleus seurat object has to be downloaded and copied into the 'SN_RNAseq_atlas_v2_2024November01' subdirectory. For download links see 'https://www.kpmp.org/doi-collection/10-48698-16dd-vj20' or 'https://cellxgene.cziscience.com/collections/9c9d04c4-8899-417f-bb6f-6107dcadf14f'.
