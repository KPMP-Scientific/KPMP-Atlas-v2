...
Sample_meta=readtable('Tissue_resident_macrophages_pseudobulk/Samples_Conditions_and_cell_numbers_I_14_15.csv');
...
Peak_sc_diff_all = readtable('Tissue_resident_macrophages_pseudobulk/All_samples_I_14_15_ATAC_markers.csv');
...
RNA_sc_diff_all = readtable('Tissue_resident_macrophages_pseudobulk/All_samples_I_14_15_RNA_markers.csv');
...
for p=1:length(Candidate_clusters) 
    ATAC = readtable(['Tissue_resident_macrophages_pseudobulk/Pseudo_bulk_MAC_MNP_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
    ...
    RNA = readtable(['Tissue_resident_macrophages_pseudobulk/Pseudo_bulk_MAC_MNP_RNA_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
...
save('I14_I15_trajectory_MAGICAL.mat')

clear

load I14_I15_trajectory_MAGICAL.mat

CollecTRI_regulons=readtable('CollecTRI_regulons.txt', 'delimiter', ',');

fid=fopen('V2_Kidney_I14_I15_all_samples_trajectory_MAGICAL_circuits.txt', 'w');
...
MAGICAL_circuits=readtable('V2_Kidney_I14_I15_all_samples_trajectory_MAGICAL_circuits.txt');
