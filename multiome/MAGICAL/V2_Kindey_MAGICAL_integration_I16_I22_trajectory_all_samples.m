...
Sample_meta=readtable('Monocytes_macrophages_pseudobulk/Samples_Conditions_and_cell_numbers_I_16_22.csv');
...
Peak_sc_diff_all = readtable('Monocytes_macrophages_pseudobulk/All_samples_I_16_22_ATAC_markers.csv');
...
RNA_sc_diff_all = readtable('Monocytes_macrophages_pseudobulk/All_samples_I_16_22_RNA_markers.csv');
...
for p=1:length(Candidate_clusters) 
    ATAC = readtable(['Monocytes_macrophages_pseudobulk/Pseudo_bulk_16_22_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
    ...
    RNA = readtable(['Monocytes_macrophages_pseudobulk/Pseudo_bulk_16_22_RNA_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
...
save('I16_I22_trajectory_MAGICAL.mat')

clear

load I16_I22_trajectory_MAGICAL.mat

CollecTRI_regulons=readtable('CollecTRI_regulons.txt', 'delimiter', ',');

fid=fopen('V2_Kidney_I16_I22_all_samples_trajectory_MAGICAL_circuits.txt', 'w');
...
MAGICAL_circuits=readtable('V2_Kidney_I16_I22_all_samples_trajectory_MAGICAL_circuits.txt');
