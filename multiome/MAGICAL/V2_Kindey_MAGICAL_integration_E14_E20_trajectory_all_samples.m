...
Sample_meta=readtable('Peritubular_Capilaries_pseudobulk/Samples_Conditions_and_cell_numbers_E14_E20.csv');
...
Peak_sc_diff_all = readtable('Peritubular_Capilaries_pseudobulk/All_samples_E14_E20_ATAC_markers.csv');
...
RNA_sc_diff_all = readtable('Peritubular_Capilaries_pseudobulk/All_samples_E14_E20_RNA_markers.csv');
...
for p=1:length(Candidate_clusters) 
    ATAC = readtable(['Peritubular_Capilaries_pseudobulk/Pseudo_bulk_E14_E20_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
    ...
    RNA = readtable(['Peritubular_Capilaries_pseudobulk/Pseudo_bulk_E14_E20_RNA_count_',Candidate_clusters{p},'_All_samples.txt'], 'ReadVariableNames',true);
...
save('E14_E20_trajectory_MAGICAL.mat')

clear

load E14_E20_trajectory_MAGICAL.mat

CollecTRI_regulons=readtable('CollecTRI_regulons.txt', 'delimiter', ',');

fid=fopen('V2_Kidney_E14_E20_all_samples_trajectory_MAGICAL_circuits.txt', 'w');
...
MAGICAL_circuits=readtable('V2_Kidney_E14_E20_all_samples_trajectory_MAGICAL_circuits.txt');
