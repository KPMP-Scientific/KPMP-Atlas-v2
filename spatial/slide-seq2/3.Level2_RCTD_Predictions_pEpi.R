...
ref <- subset(ref, idents = "aDTL", invert = TRUE) #over predicts
...
kss.sub <- subset(kss, v2.subclass.l1 %in% c("POD","PEC","PT","TL"))
table(kss.sub$v2.subclass.l1)
...
save(RCTD, file = "~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Intermediate_Objects/Proximal-Epithelial_Combined_RCTD_07222024.rda")
#load("~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Intermediate_Objects/Proximal-Epithelial_Combined_RCTD_07222024.rda")
...
save(kss.sub, file = "~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Spatial_object_filtered_09-02-2023/Kidney_Slide-seq_Spatial_Atlas_V2_pEpi_subset_07232024.Rda")
