...
ref <- subset(ref, v2.subclass.l1 %in% c("TAL","DCT","CNT","PC","IC"))
...
kss.sub <- subset(kss, v2.subclass.l1 %in% c("TAL","DCT","CNT","PC","IC"))
...
save(RCTD, file = "~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Intermediate_Objects/Distal-Epithelial_Combined_RCTD_07232024.rda")
#load("~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Intermediate_Objects/Distal-Epithelial_Combined_RCTD_07232024.rda")
...
save(kss.sub, file = "~/hsKidAt/blake_LTS/Atlas_V2/spatial/slide-seq/Spatial_object_filtered_09-02-2023/Kidney_Slide-seq_Spatial_Atlas_V2_dEpi_subset_07282024.Rda")
