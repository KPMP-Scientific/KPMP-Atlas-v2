...
scsn$v2.cluster = ''
sort(table(scsn$v2.subclass.l3))
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "cMON"] = 'MYL1'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "ncMON"] = 'MYL2'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "cDC2"] = 'MYL3'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "resMAC-LYVE1+"] = 'MYL4'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MYL-TAL_doub"] = 'MYL5'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "resMAC-HLAIIhi"] = 'MYL6'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "moMAC-C3+"] = 'MYL7'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "moMAC-FAM"] = 'MYL8'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MYL-T_doub"] = 'MYL9'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MYL-PT_doub"] = 'MYL10'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "moMAC-CXCL10+"] = 'MYL11'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "cDC1"] = 'MYL12'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "moMAC-LUCAT1+"] = 'MYL13'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MYL-EC_doub"] = 'MYL14'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "cycMAC"] = 'MYL15'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MYL_NonSpecific"] = 'MYL16'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "moMAC-HBEGF+"] = 'MYL17'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "mDC"] = 'MYL18'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "pDC"] = 'MYL19'
scsn$v2.cluster[scsn$v2.subclass.l3 %in% "MAST"] = 'MYL20'
